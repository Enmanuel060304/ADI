...
VALUES (1, 'Collar de plata', 99.99, 100, 34),
       (2, 'Pulsera de oro', 149.99, 80, 35),
       (3, 'Aretes de diamantes', 199.99, 120, 36),
       (4, 'Anillo de compromiso', 299.99, 150, 37),
       (5, 'Broche de perlas', 79.99, 70, 34),
       (6, 'Pendientes de rubíes', 249.99, 90, 35),
       (7, 'Colgante de zafiros', 179.99, 110, 36),
       (8, 'Collar de esmeraldas', 349.99, 130, 37),
       (9, 'Pulsera de plata', 59.99, 160, 34),
       (10, 'Aretes de oro blanco', 199.99, 180, 35),
       (11, 'Anillo de amatista', 129.99, 140, 36),
       (12, 'Collar de diamantes', 499.99, 100, 37),
       (13, 'Broche de oro rosa', 89.99, 120, 34),
       (14, 'Pendientes de perlas', 129.99, 90, 35),
       (15, 'Colgante de turquesa', 159.99, 110, 36),
       (16, 'Pulsera de amatista', 79.99, 70, 37),
       (17, 'Anillo de oro amarillo', 199.99, 130, 34),
       (18, 'Aretes de plata', 49.99, 150, 35),
       (19, 'Colgante de ópalo', 169.99, 70, 36),
       (20, 'Pulsera de rubíes', 249.99, 90, 37);

--valores para tabla venta
INSERT INTO VENTA (ID, ID_CLIENTE, FECHA)
...
INSERT INTO COMPRA (ID, FECHA, ID_PROVEEDOR)
VALUES (1, '2024-04-01', 3),
       (2, '2024-04-02', 2),
       (3, '2024-04-03', 1),
       (4, '2024-04-04', 4),
       (5, '2024-04-05', 5),
